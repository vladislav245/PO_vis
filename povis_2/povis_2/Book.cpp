...
Book::Book(){
	author = new char[] {"None"};
	topic = new char[] {"None"};
	publ_office = new char[] {"None"};
	year_realease = 0;
}
...
Book::Book(const char* author, const char* topic, const char* publ_office){
...
Book::Book(const char* author, const char* topic, const char* publ_office, int year_realease) {
	this->author = new char[strlen(author) + 1];
	strcpy(this->author, author);
	this->topic = new char[strlen(topic) + 1];
	strcpy(this->topic, topic);
